...
class WashingPole
{
    ...
    public static List<Unforgiven.Champion> champIds = new List<Unforgiven.Champion>();
    ...
    public static Unforgiven.Champion GetChampFromList(IList<Unforgiven.Champion> champs, string name)
    {
